...
const services = [
  ...
  },
  {
    title: "Micro Lending",
    description:
      "Accessible loan products designed for traders, small businesses, and employed individuals. We provide flexible financing solutions to help you grow and meet your financial goals.",
    image: "/images/micro-bg.jpg",
  },
];
...
export function WhatWeDo() {
  return (
    <section className="w-full bg-page">
      <div className="max-w-7xl mx-auto px-6 md:px-10 pt-4 md:pt-2">
        <h2 className="font-heading text-brand text-2xl md:text-3xl font-semibold">
          What We Do
        </h2>
        <p className="mt-2 text-base md:text-lg text-neutral-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          {services.map((service) => (
            <div key={service.title}>
              ...
              <h3 className="font-heading text-brand text-xl md:text-2xl font-semibold mt-5">
                {service.title}
              </h3>
